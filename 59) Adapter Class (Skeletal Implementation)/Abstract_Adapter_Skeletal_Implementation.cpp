...
This is the Default Abstract Adapter Design.
*/
// Interface => Adapter (Abstract) => Concrete
...
class B : public A // This one will be an Abstract Adapter Class (Skeletal Class)
{
public:
...
class MyWorker : public B // (Concrete Class)
{
public:
    void f3() override
    {
...
/*
Class B provides default empty implementations for an interface (Class A) so that derived classes (MyWorker) only need to override the specific methods they care about.
