...
// E.g : if we use ostream obj to redirect its buffer to ofstream's buffer / cout's buffer , then the streambuf* of ostream obj is pointing to derived now instead of base class ( totally fine !)
