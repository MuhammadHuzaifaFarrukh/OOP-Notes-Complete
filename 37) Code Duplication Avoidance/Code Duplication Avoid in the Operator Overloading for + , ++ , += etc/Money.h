...
public:
    ...
    Money(const Money &); // Copy Constructor , Code Reusability implemented
    Money& operator=(const Money&); // Copy Assignment Operator , Code Reusability implemented

    Money operator+(const Money&); //Simple Add operator
    Money& operator+=(const Money&); // Compound Addition assignment operator , Code Reusability implemented
    Money operator++(int); //Postfix Addition Operator , Code Reusability implemented
    Money& operator++();  // Prefix Addition Operator  , Code Reusability implemented
